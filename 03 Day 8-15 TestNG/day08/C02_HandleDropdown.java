...
public class C02_HandleDropdown {
    ...
    @Test
    public void dropdrownTesti(){
        // Dropdown'da var alan seceneklerden birini secmek icin
        // 1. adim: Dropdown webelementini locate edip bir
        ...
        // ve parametre olarak loate ettigimiz Webelementi yazalim

        Select select=new Select(dropdownElementi);

        // 3. adim select objesini kullanarak, Select class'inda var olan 3 secim method'undan
        // istedigimizi kullanarak dropdown'da var olan option'lardan birini secebiliri
        // secim ypamamiza yardim eden bu 3 method void'dir dolayisila bize bir sey dondurmezler
