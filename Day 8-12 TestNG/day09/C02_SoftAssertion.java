...
public class C02_SoftAssertion {
    ...
    public void test01(){
        ...
        //6. Online banking yazisi altinda Pay Bills sayfasina gidin
        driver.navigate().back(); // guvenli degil  uyarisini geciyor
        driver.findElement(By.xpath("//strong[text()='Online Banking']")).click();
        driver.findElement(By.xpath("//span[@id='pay_bills_link']")).click();
        //7. online banking menusu icinde “Purchase Foreign Currency” tusuna basin
        ...
        System.out.println("Hard assertion olsaydi ve ilk assertion failed olsaydi, bu satir calismazdi");
        ...
        //(peso)","Norway (krone)","New Zealand (dollar)","Sweden (krona)","Singapore (dollar)","Thailand (baht)"
        ...
        actualOptionListesiStringOlarak=actualOptionListesiStringOlarak.trim();
